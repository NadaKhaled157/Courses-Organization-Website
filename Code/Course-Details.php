...
<div style="height: 200px; background-color: #1c1f4c;">
    ...
    <div class="rating px-5 mx-5">
        ...
        <p class="text d-inline">4.5</p>
            <div class="arrow-box" id="hover-content">
                REVIEWS
                <br>
                userName ******
                <br>
...
<div class="card ms-sm-3 ms-md-5 mt-4" style="width:20rem; background-color: #faf1d7">
    <div class="card-body">
...
<div class="card ms-sm-3 ms-md-5 mt-4" style="width:20rem; background-color: #00848c">
    <div class="card-body">
...
<div class="card ms-sm-3 ms-md-5 my-3" style="width:20rem; background-color: #00848c">
    <div class="card-body">
    ...
    <div class="card ms-sm-3 ms-md-5 my-3" style="width:20rem; background-color: #faf1d7">
        <div class="card-body">
            ...
            <label>
                ...
                <button type="submit" class="btn btn-vintage mt-2 d-inline" style="margin-left:210px;">Submit</button>
        </div>
    </div>
</div>
<!--</div>-->
