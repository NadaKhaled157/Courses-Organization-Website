...
<!--<form action="course-data.php" method="get">-->
...
<!--                <a href="course-data.php?courseID='RO'" class="course btn btn-vintage d-grid gap-2 d-md-flex justify-content-md-end">Course Details</a>-->
...
<!--            <div class="d-grid gap-2 d-md-flex justify-content-md-end">-->
<!--                <a href="#" class="course btn btn-vintage d-grid gap-2 d-md-flex justify-content-md-end">Course Details</a>-->
<!--<!--                <input type="submit" name="courseID" class="course btn btn-vintage d-grid gap-2 d-md-flex justify-content-md-end" value="Course Details">-->-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
