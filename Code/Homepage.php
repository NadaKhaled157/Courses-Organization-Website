...
<!--            <img id="carousel-image2" src="../Photos/carousel2.jpg" class="d-block w-100" alt="...">-->
<!--            <div class="carousel-caption d-none d-md-block">-->
<!--                <h5>Automotive Workshop</h5>-->
<!--                <p>Are you a mechanical engineer? Enroll to our Automotive Workshop now!</p>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="carousel-item">-->
<!--            <img src="../Photos/carousel3.jpg" class="d-block w-100" alt="...">-->
<!--            <div id="carousel-image3" class="carousel-caption d-none d-md-block">-->
...
<!--        <img src="../Photos/robotics.jpg" class="card-img-top" alt="Robotics">-->
<!--        <div class="card-body">-->
...
<!--    </div>-->
<!--    <div class="card d-inline-block mx-auto my-2 col-sm-6" style="width: 18rem;">-->
<!--        <img src="../Photos/web-dev.jpg" class="card-img-top" alt="Web Development">-->
<!--        <div class="card-body">-->
...
<!--    </div>-->
<!--    <div class="card d-inline-block mx-auto my-2 col-sm-6" style="width: 18rem;">-->
<!--        <img src="../Photos/python.jpg" class="card-img-top" alt="Web Development">-->
<!--        <div class="card-body">-->
...
<!--    </div>-->
<!--    <div class="card d-inline-block mx-auto my-2 col-sm-6" style="width: 18rem;">-->
<!--        <img src="../Photos/c-programming.jpg" class="card-img-top" alt="Web Development">-->
<!--        <div class="card-body">-->
